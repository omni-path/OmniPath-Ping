...
{
public:
  struct AssignDebugStats
  {
    uint32_t containers;
    uint32_t devices;
    uint32_t createdInterfaces;
    uint64_t containerGetUs;
    uint64_t getNodeUs;
    uint64_t getIpv4Us;
    uint64_t getInterfaceForDeviceUs;
    uint64_t addInterfaceUs;
    uint64_t newAddressUs;
    uint64_t addAddressUs;
    uint64_t setMetricUpUs;
    uint64_t retvalAddUs;
 ...
 */
  ...
  static void SetAssignDebug (bool enabled);
  static void ResetAssignDebugStats ();
  static AssignDebugStats GetAndResetAssignDebugStats ();
