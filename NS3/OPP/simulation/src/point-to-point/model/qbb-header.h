...
public:
  ...
  enum {
	  FLAG_CNP = 0,
	  FLAG_RPINGMESH_FAULT = 1,
	  FLAG_RPINGMESH_TRACEROUTE = 2
  };
...
//Setters
  ...
  void SetCnp();
  void SetRpingmeshFault();
  void SetRpingmeshTraceroute();
...
//Getters
  ...
  uint8_t GetRpingmeshFault() const;
  uint8_t GetRpingmeshTraceroute() const;
