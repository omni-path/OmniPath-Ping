...
{
public:
  struct InstallDebugStats
  {
    uint32_t links;
    uint64_t createDeviceUs;
    uint64_t setAddressUs;
    uint64_t addDeviceUs;
    uint64_t queueUs;
    uint64_t mpiCheckUs;
    uint64_t createChannelUs;
    uint64_t attachUs;
    uint64_t containerUs;
  ...
  static void SetInstallDebug (bool enabled);
  static void ResetInstallDebugStats ();
  static InstallDebugStats GetAndResetInstallDebugStats ();
