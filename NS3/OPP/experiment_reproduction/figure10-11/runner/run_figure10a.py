#!/usr/bin/env python3
"""Run Figure 10(a): fat-tree OPP sampled-USM completion time vs m multiplier.
...
def build_tasks(args, repo_root, figure_dir, work_root):
    ...
    for k in args.k:
        ...
        topology_file = (
            ...
            ("fattree_%s_topology.txt" % topo_key)
        )
        flow_file = figure_dir / "traffic_load" / "fattree" / topo_key / "flow_2e0.txt"
...
def parse_args():
    ...
    parser.add_argument("--multiplier", type=int, nargs="+",
                        ...
                        help="multiplier sweep; m1/m2/m3=base*multiplier")
...
def main():
    ...
    if args.work_dir is None:
        temp_work_dir = tempfile.TemporaryDirectory(prefix="figure10a_")
