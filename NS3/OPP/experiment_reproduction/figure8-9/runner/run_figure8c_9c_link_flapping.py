#!/usr/bin/env python3
"""Run Figure 8(c)/9(c) link-flapping sweeps on k=64 fat-tree."""
...
DEFAULT_OUTPUT_FILE = "Figure8(c)_results.csv"
DEFAULT_F1_OUTPUT_FILE = "Figure9(c)_results.csv"
...
def main():
    ...
    if args.work_dir is None:
        temp_work_dir = tempfile.TemporaryDirectory(prefix="figure8c_link_flapping_")
