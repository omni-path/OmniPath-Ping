#!/usr/bin/env python3
"""Run Figure 8(b)/9(b) forwarding-loop sweeps on k=64 fat-tree."""
...
DEFAULT_OUTPUT_FILE = "Figure8(b)_results.csv"
DEFAULT_F1_OUTPUT_FILE = "Figure9(b)_results.csv"
...
def main():
    ...
    parser.add_argument("--output-file", type=pathlib.Path, default=None,
                        help="result CSV; default is results/Figure8(b)_results.csv")
    parser.add_argument("--f1-output-file", type=pathlib.Path, default=None,
                        help="F1 CSV; default is results/Figure9(b)_results.csv")
    ...
    if args.work_dir is None:
        temp_work_dir = tempfile.TemporaryDirectory(prefix="figure8b_loop_")
