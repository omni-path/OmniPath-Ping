#!/usr/bin/env python3
"""Run Figure 8(d)/9(d) congestion sweeps on k=64 fat-tree."""
...
DEFAULT_OUTPUT_FILE = "Figure8(d)_results.csv"
DEFAULT_F1_OUTPUT_FILE = "Figure9(d)_results.csv"
...
def main():
    ...
    if args.work_dir is None:
        temp_work_dir = tempfile.TemporaryDirectory(prefix="figure8d_congestion_")
