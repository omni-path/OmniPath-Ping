#!/usr/bin/env python3
"""Run Figure 6 3D-torus coverage sweeps.
...
DEFAULT_OUTPUT_FILE = "Figure6(d)_results.csv"
...
def build_tasks(args, repo_root, figure6_dir, work_root):
    ...
    for k in args.k:
        ...
        flow_dir = figure6_dir / "traffic_load" / "3d_torus" / topology
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run 3D-torus average-coverage sweeps for Figure 6.")
    ...
    parser.add_argument("--output-file", type=pathlib.Path, default=None,
                        help="coverage-matrix CSV result file; default is results/Figure6(d)_results.csv")
    ...
    if args.work_dir is None:
        temp_work_dir = tempfile.TemporaryDirectory(prefix="figure6d_")
