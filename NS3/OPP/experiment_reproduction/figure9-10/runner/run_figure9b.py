#!/usr/bin/env python3
"""Run Figure 9(b): leaf-spine OPP sampled-USM completion time vs m multiplier.
...
DEFAULT_OUTPUT_FILE = "Figure9(b)_results.csv"
...
def main():
    ...
    if args.work_dir is None:
        temp_work_dir = tempfile.TemporaryDirectory(prefix="figure9b_")
