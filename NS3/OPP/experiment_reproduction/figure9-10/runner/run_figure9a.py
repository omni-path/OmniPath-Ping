#!/usr/bin/env python3
"""Run Figure 9(a): fat-tree OPP sampled-USM completion time vs m multiplier.
...
DEFAULT_OUTPUT_FILE = "Figure9(a)_results.csv"
...
def main():
    ...
    if args.work_dir is None:
        temp_work_dir = tempfile.TemporaryDirectory(prefix="figure9a_")
