#!/usr/bin/env python3
"""Run Figure 9(c): 2D torus OPP sampled-USM completion time vs m.
...
DEFAULT_OUTPUT_FILE = "Figure9(c)_results.csv"
...
def main():
    ...
    if args.work_dir is None:
        temp_work_dir = tempfile.TemporaryDirectory(prefix="figure9c_")
