#!/usr/bin/env python3
"""Generate Figure 10(a): fat-tree OPP cache-entry bound vs multiplier."""
...
DEFAULT_OUTPUT_FILE = "Figure10(a)_results.csv"
...
def parse_args():
    ...
    parser.add_argument("--base-m1", type=int, default=10,
                        help="base OPP_FATTREE_M1, matching Figure 9(a)")
    parser.add_argument("--base-m2", type=int, default=10,
                        help="base OPP_FATTREE_M2, matching Figure 9(a)")
    parser.add_argument("--base-m3", type=int, default=1,
                        help="base OPP_FATTREE_M3, matching Figure 9(a)")
