#!/usr/bin/env python3
"""Generate Figure 10(b): leaf-spine OPP cache-entry bound vs multiplier."""
...
def parse_args():
    ...
    parser.add_argument("--base-m1", type=int, default=10,
                        help="base OPP_LEAFSPINE_M1, matching Figure 9(b)")
    parser.add_argument("--base-m2", type=int, default=10,
                        help="base OPP_LEAFSPINE_M2, matching Figure 9(b)")
