#!/usr/bin/env python3
"""Run Figure 5 fat-tree coverage sweeps.
...
DEFAULT_OUTPUT_FILE = "Figure5(a)_results.csv"
...
def build_tasks(args, repo_root, figure5_dir, work_root):
    ...
    for k in args.k:
        ...
        flow_dir = figure5_dir / "traffic_load" / "fattree" / topology
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run fat-tree average-coverage sweeps for Figure 5.")
    ...
    parser.add_argument("--output-file", type=pathlib.Path, default=None,
                        help="coverage-matrix CSV result file; default is results/Figure5(a)_results.csv")
    ...
    if args.work_dir is None:
        temp_work_dir = tempfile.TemporaryDirectory(prefix="figure5a_")
