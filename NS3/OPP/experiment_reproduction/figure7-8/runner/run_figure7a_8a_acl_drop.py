#!/usr/bin/env python3
"""Run Figure 7(a)/8(a) ACL-drop recall sweeps on k=64 fat-tree."""
...
DEFAULT_OUTPUT_FILE = "Figure7(a)_results.csv"
DEFAULT_F1_OUTPUT_FILE = "Figure8(a)_results.csv"
...
def main():
    ...
    parser.add_argument("--output-file", type=pathlib.Path, default=None,
                        help="result CSV; default is results/Figure7(a)_results.csv")
    parser.add_argument("--f1-output-file", type=pathlib.Path, default=None,
                        help="F1 CSV; default is results/Figure8(a)_results.csv")
    ...
    if args.work_dir is None:
        temp_work_dir = tempfile.TemporaryDirectory(prefix="figure7a_acl_")
